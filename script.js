...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const champData = {
    male: [
      { name: '가렌', id: 'Garen' },
      { name: '갈리오', id: 'Galio' },
      { name: '갱플랭크', id: 'Gangplank' },
      { name: '그라가스', id: 'Gragas' },
      { name: '그레이브즈', id: 'Graves' },
      { name: '나서스', id: 'Nasus' },
      { name: '노틸러스', id: 'Nautilus' },
      { name: '녹턴', id: 'Nocturne' },
      { name: '누누와 윌럼프', id: 'Nunu' },
      { name: '다리우스', id: 'Darius' },
      { name: '라이즈', id: 'Ryze' },
      { name: '라칸', id: 'Rakan' },
      { name: '람머스', id: 'Ramus' },
      { name: '럼블', id: 'Rumble' },
      { name: '레넥톤', id: 'Renekton' },
      { name: '렝가', id: 'Rengar' },
      { name: '루시안', id: 'Lucian' },
      { name: '리 신', id: 'LeeSin' },
      { name: '마스터 이', id: 'MasterYi' },
      { name: '마오카이', id: 'Maokai' },
      { name: '말자하', id: 'Malzahar' },
      { name: '말파이트', id: 'Malphite' },
      { name: '모데카이저', id: 'Mordekaiser' },
      { name: '문도 박사', id: 'DrMundo' },
      { name: '바드', id: 'Bard' },
      { name: '바루스', id: 'Varus' },
      { name: '바이', id: 'Vi' },
      { name: '베이가', id: 'Veigar' },
      { name: '벨코즈', id: 'Velkoz' },
      { name: '볼리베어', id: 'Volibear' },
      { name: '브라움', id: 'Braum' },
      { name: '브랜드', id: 'Brand' },
      { name: '블라디미르', id: 'Vladimir' },
      { name: '블리츠크랭크', id: 'Blitzcrank' },
      { name: '비에고', id: 'Viego' },
      { name: '빅토르', id: 'Viktor' },
      { name: '사이온', id: 'Sion' },
      { name: '사일러스', id: 'Sylas' },
      ...
      { name: '스웨인', id: 'Swain' },
      { name: '스카너', id: 'Skarner' },
      { name: '신 짜오', id: 'XinZhao' },
      { name: '신지드', id: 'Singed' },
      { name: '쓰레쉬', id: 'Thresh' },
      { name: '아무무', id: 'Amumu' },
      { name: '아우렐리온 솔', id: 'AurelionSol' },
      { name: '아이번', id: 'Ivern' },
      { name: '아지르', id: 'Azir' },
      { name: '아크샨', id: 'Akshan' },
      { name: '아트록스', id: 'Aatrox' },
      { name: '알리스타', id: 'Alistar' },
      { name: '야스오', id: 'Yasuo' },
      { name: '에코', id: 'Ekko' },
      { name: '오공', id: 'MonkeyKing' },
      { name: '오른', id: 'Ornn' },
      { name: '올라프', id: 'Olaf' },
      { name: '요네', id: 'Yone' },
      { name: '요릭', id: 'Yorick' },
      ...
      { name: '코르키', id: 'Corki' },
      { name: '클레드', id: 'Kled' },
      { name: '킨드레드', id: 'Kindred' },
      { name: '타릭', id: 'Taric' },
      { name: '탈론', id: 'Talon' },
      { name: '트런들', id: 'Trundle' },
      { name: '트린다미어', id: 'Tryndamere' },
      { name: '트위스티드 페이트', id: 'TwistedFate' },
      { name: '트위치', id: 'Twitch' },
      { name: '판테온', id: 'Pantheon' },
      { name: '피들스틱', id: 'Fiddlesticks' },
      { name: '피즈', id: 'Fizz' },
    ...
    female: [
      ...
      { name: '룰루', id: 'Lulu' },
      { name: '르블랑', id: 'Leblanc' },
      { name: '리산드라', id: 'Lissandra' },
      { name: '리븐', id: 'Riven' },
      { name: '릴리아', id: 'Lillia' },
      { name: '모르가나', id: 'Morgana' },
      { name: '미스 포츈', id: 'MissFortune' },
      { name: '벨베스', id: 'Belveth' },
      { name: '벡스', id: 'Vex' },
      { name: '뽀삐', id: 'Poppy' },
      { name: '사미라', id: 'Samira' },
      { name: '세나', id: 'Senna' },
      { name: '세라핀', id: 'Seraphine' },
      { name: '세주아니', id: 'Sejuani' },
      { name: '소나', id: 'Sona' },
      { name: '소라카', id: 'Soraka' },
      { name: '쉬바나', id: 'Shyvana' },
      { name: '시비르', id: 'Sivir' },
      ...
      { name: '카르마', id: 'Karma' },
      { name: '카밀', id: 'Camille' },
      { name: '카시오페아', id: 'Cassiopeia' },
      { name: '카이사', id: 'Kaisa' },
      { name: '카타리나', id: 'Katarina' },
      { name: '칼리스타', id: 'Kalista' },
      { name: '케이틀린', id: 'Caitlyn' },
      { name: '케일', id: 'Kayle' },
      { name: '퀸', id: 'Quinn' },
      { name: '트리스타나', id: 'Tristana' },
      { name: '피오라', id: 'Fiora' },
      { name: '브라이어', id: 'Briar' },
      { name: '밀리오', id: 'Milio' },
      { name: '레나타 글라스크', id: 'Renata' },
    ],
  }

  function getChampImg(id) {
    if (!id)
      return 'https://ddragon.leagueoflegends.com/cdn/13.24.1/img/champion/Garen.png'
  ...
  async function predict(inputElement) {
    ...
    if (mValue > fValue) {
      if (
        !isWebcamActive ||
        champImg.src === '' ||
        champImg.src.includes('Garen.png')
      ) {
        const randomChamp =
          champData.male[Math.floor(Math.random() * champData.male.length)]
      ...
      if (
        ...
        const randomChamp =
          champData.female[Math.floor(Math.random() * champData.female.length)]
        champImg.src = getChampImg(randomChamp.id)
        resultLabel.textContent = `당신은 "${randomChamp.name}" 상!`
